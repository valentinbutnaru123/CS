...
public class TIC_325 {
    private WebDriver driver;

    @Given("Launch Chrome browser TIC_325")
    ...
    @And("Open loving-hermann.com page TIC_325")
    ...
    @And("Press on SEND button TIC_325")
    ...
    @Then("Close the browser TIC_325")
