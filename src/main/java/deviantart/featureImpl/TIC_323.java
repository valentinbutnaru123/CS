...
public class TIC_323 {
    private WebDriver driver;

    @Given("Launch Chrome browser TIC_323")
    ...
    @And("Click on product quick view TIC_323")
    ...
    @Then("Close the browser TIC_323")
