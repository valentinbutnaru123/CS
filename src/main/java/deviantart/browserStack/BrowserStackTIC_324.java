...
public class BrowserStackTIC_324 {
    public static final String USERNAME = "valentinbutnaru1";
    public static final String AUTOMATE_KEY = "hdEgDE5ZmVi5sPLHiCqH";
    ...
    public static void launch_chrome_browser() throws MalformedURLException {
        ...
        caps.setCapability("name", "TIC-324");
